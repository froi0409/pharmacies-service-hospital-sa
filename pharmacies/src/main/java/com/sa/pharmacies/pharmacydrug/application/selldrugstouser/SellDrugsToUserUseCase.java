...
public class SellDrugsToUserUseCase implements SellDrugsToUserInputPort {
    ...
    @Autowired
    public SellDrugsToUserUseCase(FindPharmacyByIdOutputPort findPharmacyByIdOutputPort, FindDrugByCodeOutputPort findDrugByCodeOutputPort, FindPharmacyDrugOutputPort findPharmacyDrugOutputPort, UpdatePharmacyDrugOutputPort updatePharmacyDrugOutputPort, BillPharmacyDrugOutputPort billPharmacyDrugOutputPort) {
